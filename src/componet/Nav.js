    ...
    return (
        <div>
            <div className="bg-fourthLGreen/90 flex text-firstWhite fixed w-full  justify-between text-2xl  h-20  z-[999]   ">
                ...
                <div className={`col-span-4 w-auto px-7 h-screen text-xl mt-20 flex flex-col  -z-[999] duration-100 -mx-96 absolute ${show ? "mx-0" : null} md:flex-row md:w-8/12 md:h-20  md:justify-center items-center font-mono w-full  p-3   md:my-0 md:static md:z-0 md:gap-14 md:px-8 md:col-span-5  `}>
                    <Link to="/"><div >Home</div></Link>
                    <Link to="/suit"><div>Suit</div></Link>
                    <Link to="/kurties"> <div>Kurties</div></Link>
                    <Link to="/bedsheets"> <div>Bedsheets</div></Link>
                    <div>About Us</div>
                </div>
